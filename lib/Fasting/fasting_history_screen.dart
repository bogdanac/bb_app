          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                _buildSummaryItem(
                  'Longest Fast',
                  _formatDuration(_editableHistory.map((f) => f['actualDuration'] as int).reduce((a, b) => a > b ? a : b)),
                ...
                _buildSummaryItem(
                  'Average Fast',
                  _formatDuration((_editableHistory.map((f) => f['actualDuration'] as int).reduce((a, b) => a + b) / _editableHistory.length).round()),
